package com.example.wykop.domain.api;

import com.example.wykop.domain.discovery.Discovery;
import com.example.wykop.domain.discovery.DiscoveryDao;
import com.example.wykop.domain.user.UserDao;
import com.example.wykop.domain.vote.VoteDao;
